...
<body style="background-color: burlywood">
  ...
  <header>
      <ul class="nav justify-content-center">
          <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="project/board.do" style="margin: 0 50px;">동네길 추천</a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="project/board.do" style="margin: 0 50px;">걷기 친구 찾기</a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="project/board.do" style="margin: 0 50px;">자유 게시판</a>
          </li>
      </ul>
  </header>
